...
//  MyPump
//
//  Created by Александр Майко on 17.01.2021.
//
...
struct Constants {
    struct FirebaseRef {
        ...
        static let brinkmann450Units = brinkmannModelsRef.child("450").child("Units")
        static let brinkmann550Units = brinkmannModelsRef.child("550").child("Units")
